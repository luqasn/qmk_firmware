...
[_QWERTY] = LAYOUT_planck_mit(
    ...
    KC_LGUI, KC_LCTL, _______, KC_LALT, LOWER, KC_SPC,  RAISE,   RALT_T(KC_SLSH), KC_LEFT, KC_DOWN, KC_RGHT
),
...
[_RAISE] = LAYOUT_planck_mit(
    ...
    _______, _______, _______, _______, _______, KC_BSPC, _______, _______, KC_MPLY, KC_VOLD, KC_MNXT
),
